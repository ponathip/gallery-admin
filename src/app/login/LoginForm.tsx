  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f7f7f4] px-5">
      ...
      >
        ...
        <h1 className="max-w-full text-[38px] font-serif text-black/50 leading-none tracking-tight text-neutral-500 sm:text-5xl first-letter:text-[1.18em] first-letter:mr-[1px]">PhanatchaNuch</h1>
